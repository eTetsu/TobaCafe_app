...
大手グルメサイトで「喫煙可」「カフェ」で検索しても、多くの選択肢がヒットして、求めている「気軽に長居できる喫煙カフェ」がなかなか見つかりにくい。
このような非常に私的なニーズから、「集中できる作業場所」を探している喫煙者のためのコスパ良く長居できる喫煙カフェだけを集めたアプリを作成を考えるに至ったのだった。
...
これらのユーザーに共通するのは、「喫煙者である」「自宅だと気が散る」「ある程度の衆人環視が好ましい」という3つのニーズです。
...
- 作業場所の慣れ防止: いつもの作業場所で集中できなった場合に、新たな作業場所を提案
